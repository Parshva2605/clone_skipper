  ...
  return (
    <div className="flex items-center gap-4">
      <a href="https://skiper-ui.com/" className="flex gap-2 items-center">
        ...
        <span className="text-xs border-1 border-orange-600 text-orange-600 rounded-full px-2  ">Beta</span>
      </a>
      <a href="" className="text-gray-400 font-medium text-sm">Components</a>
      <a href="" className="text-gray-400 font-medium text-sm">Pricing</a>
      <a href="" className="text-gray-400 font-medium text-sm">Newsletter</a>
    </div>
  );
};
